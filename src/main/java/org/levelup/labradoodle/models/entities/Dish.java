...
@NamedQueries({
        ...
        @NamedQuery(name = "getDishByType", query = "SELECT a FROM Dish a WHERE a.typesOfDishes = ?"),
        @NamedQuery(name = "getDishesByRestaurant", query="SELECT a FROM Dish a WHERE a.restaurant= :id")
})
